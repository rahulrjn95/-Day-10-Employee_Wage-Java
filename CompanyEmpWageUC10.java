...
public class CompanyEmpWageUC10 {
    ...
    CompanyEmpWageUC10(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
...
public class EmployeeWageComputationUC10
{
    // class constants
    ...
    public EmployeeWageComputationUC10(int noOfCompanies)
    {
    ...
    {
        EmployeeWageComputationUC10 employeeWageComputation = new EmployeeWageComputationUC10(3);
