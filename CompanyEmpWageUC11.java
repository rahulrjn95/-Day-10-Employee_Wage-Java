...
interface IEmployeeWageComputationUC11
{
...
public class CompanyEmpWageUC11 {
    ...
    CompanyEmpWageUC11(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
...
class EmployeeWageComputationUC11 implements IEmployeeWageComputationUC11
{
    // class constants
    ...
    public EmployeeWageComputationUC11(int noOfCompanies)
    {
    ...
    {
        EmployeeWageComputationUC11 employeeWageComputation = new EmployeeWageComputationUC11(3);
