...
interface IEmployeeWageComputationUC14
{
...
public class CompanyEmpWageUC14 {
    // instance constants
    ...
    CompanyEmpWageUC14(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
...
class EmployeeWageComputationUC14 implements IEmployeeWageComputationUC14
{
    // class constants
    ...
    //defalut constructor
    public EmployeeWageComputationUC14()
    {
        companies = new ArrayList<>();
        totalEmpWages = new HashMap<>();
    }

    //it creates companyempwage objects and add to the arraylist
    public void addCompany(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
    ...
    {
        EmployeeWageComputationUC14 employeeWageComputation = new EmployeeWageComputationUC14();
